...
#Thiet lap Tai   
set rate  [expr 2000000 + 100000 * 8]
set rate1 [expr 3000000 + 100000 * 8]
set rate2 [expr 3000000 + 100000 * 8]
set rate3 [expr 4000000 + 100000 * 8]
set rate4 [expr 4000000 + 100000 * 8]
set rate5 [expr floor(rand()*9999000)+2000000]
puts "Tai 5: $rate5"
